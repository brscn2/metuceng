...
int main()
{
    unsigned short arr[] = {5, 23, 3, 98, 45, 1, 90};
    long swap = 0;
    double avg_dist = 0;
    double max_dist = 0;
    bool hoare = false;
    bool median_of_3 = true;
    int size = 7;

    int answer = quickSort(arr, swap, avg_dist, max_dist, hoare, median_of_3, size);
    std::cout << answer << "\n";
    std::cout << "# of swaps: " << swap << "\n";
    std::cout << "avg_dist: " << avg_dist << "\n";
